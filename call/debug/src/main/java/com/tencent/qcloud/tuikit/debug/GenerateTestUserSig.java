...
public class GenerateTestUserSig {
     ...
     * <p>
     * You can view your `SDKAppId` after creating an application in the [Tencent Cloud IM console](https://console
     * .tencentcloud.com/im).
     ...
     * <p>
     * Step 1. Log in to the [IM console](https://console.tencentcloud.com/im). If you don't have an application yet,
     * create one.
